...
Route::get('/quiz', [Controllers\QuizController::class, 'index'])->name('quiz.list');
Route::match(['get', 'post'], '/quiz/{slug}', [Controllers\QuizController::class, 'show'])->name('quiz.show');
