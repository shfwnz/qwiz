    ...
    const questions = [
        {
            ...
            options: ["Ketakutan akan santa claus", "Surat lamaran pekerjaan", "Krabby gendut", "dua belas"],
        ...
        <div className="flex items-center justify-center h-screen w-screen">
            ...
            {!showResult ? (
                <div className="bg-white/20 rounded-lg w-full h-2/3 px-10 mx-10">
                    <Badge className="text-xl font-bold mb-4 mt-10">Soal {currentIndex + 1} dari {questions.length}</Badge>
                    <p className="text-[30px] pt-20">{currentQuestion.question}</p>
                ...
                <div className="text-center">
                    ...
                    <p className="text-lg mb-4">Jawaban Salah: {questions.length - score}</p>
                    ...
                    <ul className="text-left list-disc pl-6">
                        ...
                        return (
                            ...
                            Jawaban kamu: <span className={ans.correct ? "text-green-600" : "text-red-600"}>{ans.selected}</span><br />
                    ...
                    <Link href="/" className="absolue p-2 bg-white rounded-lg text-black bottom-3">Kembali ke Dashboard</Link>
                </div>
            )}
        </div>
    )
