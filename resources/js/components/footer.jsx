...
export default function Footer() {
    ...
    const menuItems = [
        { src: "http://127.0.0.1:8000/storage/assets/Home.png", label: "Home", path: "/" },
        { src: "http://127.0.0.1:8000/storage/assets/Quiz.png", label: "Quiz", path: "/quiz" },
        { src: "http://127.0.0.1:8000/storage/assets/Leaderboard.png", label: "Leaderboard", path: "/leaderboard" },
        { src: "http://127.0.0.1:8000/storage/assets/User.png", label: "You", path: "/profile" },
    ];
        ...
        <div className="fixed bottom-0 left-0 w-screen min-h-[60px] bg-[#0D1520] rounded-lg grid grid-cols-4 text-center text-white py-2">
            {menuItems.map((item, index) => {
                ...
                return (
                    ...
                    >
                        <img className="w-6 h-6" src={item.src} alt={item.label} />
