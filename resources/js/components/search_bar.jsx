            ...
            <Dialog>
                <DialogTrigger asChild>
                    <Button className="rounded-md hover:bg-gray-800 bg-black/">
                        <img src="http://127.0.0.1:8000/storage/assets/Filter.png" className="w-[45px] h-[35px]" />
                    </Button>
                </DialogTrigger>
                <DialogContent className="bg-black text-white">
                    <DialogHeader>
                        <DialogTitle className="text-white">Jumlah Maksimal Peserta</DialogTitle>
                    </DialogHeader>
                    <div className="">
                        {Object.entries(maxs).map(([key, value]) => (
                            <div key={key} className="flex items-center space-x-2 space-y-5">
                                <Checkbox
                                    id={key}
